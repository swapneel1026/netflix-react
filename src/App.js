      ...
      <div className="" onClick={(e) => setfocus(false)}>
        <section className="h-screen p-4  border-b-4 relative   border-[#232323]">
          ...
          <div className="relative text-white md:max-w-[907px] lg:max-w-full text-center  mt-16 xl:mt-[158px]  flex flex-col items-center">
            ...
            <h4 className="md:text-[20px] text-[16px] lg:text-[24px]">
            ...
            <form className="flex flex-col items-center gap-2 mt-10 lg:flex-row ">
              ...
              <button
                ...
                className="lg:text-[1.5rem] lg:mt-0 mt-4 text-[20px] font-medium bg-netflix-red px-[1.5rem] lg:py-[12px] py-2 lg:leading-[24px] rounded-md"
              >
                Get Started {">"}
              </button>
            </form>
        ...
        <section className="flex lg:flex-row flex-col items-center lg:gap-2  gap-y-2   justify-center h-screen bg-black lg:px-[175px] md:px-16 px-4  border-b-4 border-t-4 border-[#232323]">
          ...
          <div className="relative flex justify-center w-full">
            <img
              src={appleTvGif}
              alt=""
              className="absolute top-10 md:top-12 w-[140px] md:w-[300px] lg:w-[220px] xl:w-[320px]"
            />
            <img
              src={AppleTv}
              alt="some"
        ...
        <section className="flex flex-col items-center  lg:gap-2 py-6   md:px-16  justify-center  bg-black lg:px-[175px] px-4 border-b-4 border-t-4 border-[#232323]">
          <h1 className="text-[48px] font-black text-white text-center">
          ...
          <h4 className="md:text-[20px] text-[16px] lg:text-[24px] text-white mt-4 ">
            Ready to watch? Enter your email to create or restart your
            membership.
          </h4>
          <form className="flex flex-col items-center gap-2 mt-4 lg:flex-row ">
            <div
              className={`flex flex-col border ${
                focus ? "border-purple-700" : "border-[#2bb871]"
              }  rounded-md bg-white bg-opacity-20 px-2 py-1`}
            >
              <label className="text-[12px] text-white text-left">
                Email address
              </label>
              <input
                type="email"
                className={`text-white lg:w-[354px] w-[250px] bg-transparent outline-none `}
                onChange={(e) => dispatch(setEmail(e.target.value))}
                onClick={(e) => {
                  e.stopPropagation();
                  setfocus(true);
            ...
            <button
              ...
              className="text-white lg:text-[1.5rem] lg:mt-0 mt-4 text-[20px] font-medium bg-netflix-red px-[1.5rem] lg:py-[12px] py-2 lg:leading-[24px] rounded-md"
            >
              Get Started {">"}
            </button>
          </form>
